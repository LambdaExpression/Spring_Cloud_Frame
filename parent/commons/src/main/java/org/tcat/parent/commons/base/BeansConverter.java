package org.tcat.parent.commons.base;

import com.google.gson.Gson;
import org.apache.commons.lang3.math.NumberUtils;
import org.tcat.parent.commons.annotation.Json;
...
public class BeansConverter {
                ...
                if (writeMethod != null) {
                    ...
                    if (!matched) {
                        ...
                        if (value instanceof String && destJson != null) {
                            value = gson.fromJson((String) value, destDescriptor.getReadMethod().getGenericReturnType());
                        }
    ...
    private static Object toValue(PropertyDescriptor srcDescriptor, Object value, Class<?> propertyType) {
        ...
        if (propertyType == BigDecimal.class) {// 对BigDecimal类型的处理
            value = (value == null) ? new BigDecimal("0") :
                    "".equals(value.toString().trim()) ? null : new BigDecimal(value.toString());
